...
class CGenerator {
//  private val nll = "\n"
//  private val newlineOnly: Seq[Generated] = Seq(NewlineOnly())
//  private val endlineOnly: Seq[Generated] = Seq(GenString(";"), NewlineOnly())
  private val newlineIndent: Seq[Generated] = Seq() //Seq(NewlineAndIndent())
  private val endlineIndent: Seq[Generated] = Seq() //Seq(GenString(";"), NewlineAndIndent())
//  private val indentUp: Seq[Generated] = Seq(IndentUp())
//  private val indentDown: Seq[Generated] = Seq(IndentDown())
...
//  implicit class SeqGenStrings(v: Seq[GenStrings]) {
//    def ++(v2: Seq[GenStrings]): Seq[GenStrings] = {
//      v ++ v2
//    }
//  }

//  private implicit def ++(v1: Seq[GenStrings], v2: Seq[GenStrings]): Seq[GenStrings] = {
//    v1 ++ v2
//  }
